...
export const CORE_API_BASE_URL = import.meta.env?.VITE_CORE_API_BASE_URL || 'http://172.30.0.1:8082/areap2';
export const MASTER_DATA_API_BASE_URL = import.meta.env?.VITE_MASTER_DATA_API_BASE_URL || 'http://172.30.0.1:8081/masterData';
export const JURISDICTION_API_BASE_URL = import.meta.env?.VITE_JURISDICTION_API_BASE_URL || 'http://172.30.0.1:8081';
