...
export const CORE_API_BASE_URL = import.meta.env?.VITE_CORE_API_BASE_URL || 'http://192.168.1.5:8082/areap2';
export const MASTER_DATA_API_BASE_URL = import.meta.env?.VITE_MASTER_DATA_API_BASE_URL || 'http://192.168.1.5:8081/masterData';
export const JURISDICTION_API_BASE_URL = import.meta.env?.VITE_JURISDICTION_API_BASE_URL || 'http://192.168.1.5:8081';
