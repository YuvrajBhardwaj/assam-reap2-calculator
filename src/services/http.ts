...
export const CORE_API_BASE_URL = import.meta.env?.VITE_CORE_API_BASE_URL || 'http://10.242.133.242:8082/areap2';
export const MASTER_DATA_API_BASE_URL = import.meta.env?.VITE_MASTER_DATA_API_BASE_URL || 'http://10.242.133.242:8081/masterData';
