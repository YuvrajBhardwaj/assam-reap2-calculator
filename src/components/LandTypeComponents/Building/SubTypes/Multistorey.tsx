  ...
  return (
    <Card className="border-maroon-200 shadow-md">
      <CardHeader className="bg-maroon-50 border-b border-maroon-100">
        <CardTitle className="text-maroon-700 text-xl">Multistorey Building Details</CardTitle>
      </CardHeader>
      <CardContent className="space-y-6 p-6">
        ...
        <div className="space-y-3 p-4 bg-white rounded-md border border-gray-200">
          ...
          <RadioGroup defaultValue="basement" className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
            <div className="flex items-center space-x-2 p-3 rounded-md border border-gray-200 hover:bg-maroon-50 hover:border-maroon-200 transition-colors">
              <RadioGroupItem value="basement" id="basement-multi" className="text-maroon-600" />
              <Label htmlFor="basement-multi">Basement</Label>
            </div>
            <div className="flex items-center space-x-2 p-3 rounded-md border border-gray-200 hover:bg-maroon-50 hover:border-maroon-200 transition-colors">
              <RadioGroupItem value="second" id="second-multi" className="text-maroon-600" />
              <Label htmlFor="second-multi">Second Floor</Label>
            </div>
            <div className="flex items-center space-x-2 p-3 rounded-md border border-gray-200 hover:bg-maroon-50 hover:border-maroon-200 transition-colors">
              <RadioGroupItem value="ground" id="ground-multi" className="text-maroon-600" />
              <Label htmlFor="ground-multi">Ground Floor</Label>
            </div>
            <div className="flex items-center space-x-2 p-3 rounded-md border border-gray-200 hover:bg-maroon-50 hover:border-maroon-200 transition-colors">
              <RadioGroupItem value="third" id="third-multi" className="text-maroon-600" />
              <Label htmlFor="third-multi">Third Floor And Above</Label>
            </div>
            <div className="flex items-center space-x-2 p-3 rounded-md border border-gray-200 hover:bg-maroon-50 hover:border-maroon-200 transition-colors">
              <RadioGroupItem value="first" id="first-multi" className="text-maroon-600" />
              <Label htmlFor="first-multi">First Floor</Label>
            </div>
            <div className="flex items-center space-x-2 p-3 rounded-md border border-gray-200 hover:bg-maroon-50 hover:border-maroon-200 transition-colors">
              <RadioGroupItem value="lower-ground" id="lower-ground-multi" className="text-maroon-600" />
              <Label htmlFor="lower-ground-multi">Lower Ground Floor</Label>
            </div>
          </RadioGroup>
        </div>
        ...
        {/* Lift Facility */}
        <div className="space-y-2">
          <Label className="text-primary font-medium">Construction Details</Label>
          <div className="flex items-center space-x-2">
            <Checkbox id="liftFacility" className="text-maroon-600" />
            <Label htmlFor="liftFacility" className="text-primary">Is the Lift Facility Available in the Building?</Label>
          </div>
        </div>
